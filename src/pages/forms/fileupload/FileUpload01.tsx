...
export default function FileUpload01() {
  ...
  return (
    <div className="flex items-center justify-center mt-16">
      <Card className="w-full mx-auto max-w-lg bg-background">
        <CardContent className="p-0">
          ...
          />
          <div className="px-6 py-3 border-t border-border bg-muted rounded-b-lg flex justify-between items-center mt-6">
